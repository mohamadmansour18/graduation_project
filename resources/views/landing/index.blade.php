                ...
                <div class="hero-visual reveal reveal--delay" id="hero-visual">
                    ...
                    <div class="phone-shell phone-shell--hero">
                        ...
                        <div class="phone-screen">
                            <img
                                src="{{ asset('images/landing/home.jpg') }}"
                                width="373"
                                height="842"
                    ...
                    <div class="experience-copy">
                        ...
                        <div class="experience-tabs" role="tablist" aria-label="واجهات تطبيق نيرد">
                            <button
                                ...
                                role="tab"
                                aria-selected="true"
                                data-screen="{{ asset('images/landing/home.jpg') }}"
                            ...
                            <button
                                ...
                                role="tab"
                                aria-selected="false"
                                data-screen="{{ asset('images/landing/quiz-mcq.jpg') }}"
                            ...
                            <button
                                ...
                                role="tab"
                                aria-selected="false"
                                data-screen="{{ asset('images/landing/quiz-flashcards.jpg') }}"
                            ...
                            <button
                                ...
                                role="tab"
                                aria-selected="false"
                                data-screen="{{ asset('images/landing/quiz-challenge.jpg') }}"
                            ...
                            <button
                                ...
                                role="tab"
                                aria-selected="false"
                                data-screen="{{ asset('images/landing/library.jpg') }}"
                            ...
                            <button
                                ...
                                role="tab"
                                aria-selected="false"
                                data-screen="{{ asset('images/landing/study-plan.jpg') }}"
                            ...
                            <button
                                ...
                                role="tab"
                                aria-selected="false"
                                data-screen="{{ asset('images/landing/community.jpg') }}"
